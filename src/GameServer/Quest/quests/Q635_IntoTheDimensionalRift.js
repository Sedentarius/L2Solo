...
// See docs/c4/quests/runtime-sources.md.
...
const DESTINATIONS = [
    ...
    { locX: -52872, locY: -250283, locZ: -7908, name: 'Catacomb of the Heretic' },
    ...
    { locX: -20604, locY: -250789, locZ: -8165, name: 'Catacomb of the Apostate' },
    ...
    { locX: 113865, locY: 84543, locZ: -6541, name: 'Catacomb of the Forbidden Path' }
];
