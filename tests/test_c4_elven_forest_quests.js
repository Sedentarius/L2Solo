...
function resolvedMapping() {
    ...
    // Both quest-givers stand where the pinned reference's Elven Village block
    // puts them, which is what identifies them.
    ...
    assert.deepEqual(spawned.get(BREMEC)[0], { locX: 50592, locY: 54896, locZ: -3352, head: 40960 },
        'Treant Bremec stands at the reference position');
}
