...
// reviewed Orc bounties Q275/Q276 and Q340 Subjugation of Lizardmen.
assert.strictEqual(result.active, 78 + require('../src/GameServer/Quest/LowLevelDefinitions').filter(d=>!d.blocked).length);
