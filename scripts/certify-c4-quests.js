...
const tests=[
    'tests/test_c4_inventory_validation.js','tests/test_c4_declarative_quests.js','tests/test_c4_starter_quests.js','tests/test_c4_beginner_quests.js','tests/test_first_profession_proof.js',
